...
function myFunction(){
    ...
    document.getElementById("demo1").innerHTML=text1.replace("Italy","France");
}
...
const matches = text3.match(/e/g);
document.getElementById("demo3").innerHTML=matches ? matches.join(","): "No Matches";
